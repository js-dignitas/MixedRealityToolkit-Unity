...
namespace Microsoft.MixedReality.Toolkit.XRSDK.OpenXR
{
    [MixedRealityController(
        ...
        "Textures/Generic_controller",
        supportedUnityXRPipelines: SupportedUnityXRPipelines.XRSDK)]
    public class HTCViveController : GenericXRSDKController
    {
        /// <summary>
        /// Constructor.
        /// </summary>
        ...
        { Debug.Log("New HTCViveController!");}

        private Vector3 currentPointerPosition = Vector3.zero;
        private Quaternion currentPointerRotation = Quaternion.identity;
        private MixedRealityPose currentPointerPose = MixedRealityPose.ZeroIdentity;

        private static readonly ProfilerMarker UpdatePoseDataPerfMarker = new ProfilerMarker("[MRTK] HTCViveController.UpdatePoseData");
